...
COPY PromptOpsLab/promptops-lab ./PromptOpsLab/promptops-lab

WORKDIR /workspace/PromptOpsLab/promptops-lab
...
COPY --from=builder /workspace/PromptOpsLab/promptops-lab /app

ENV PATH=/root/.local/bin:$PATH

EXPOSE 8000
CMD ["uvicorn", "promptops_lab.api:app", "--host", "0.0.0.0", "--port", "8000"]
